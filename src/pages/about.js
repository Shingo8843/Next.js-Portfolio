    ...
    <>
        ...
        <main className='flex w-full flex-col items-center justify-center dark:text-light'>
            <Layout className='pt-16'>
                <AnimatedText text="Crafting Intelligent Solutions with AI" className="mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-8" />
                   <div className='grid wfull grid-cols-8 gap-16 sm:gap-8'>
