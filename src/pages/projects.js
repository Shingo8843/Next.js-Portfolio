...
const FeaturedProject = ({type, title, summary, img, link, github}) => {
    return (
        <article className='w-full flex items-center justify-between rounded-3xl border-solid border-dark bg-light shadow-2xl p-12 border relative rounded-br-2xl dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
            ...
            <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-fulllg:pl-0 lg:pt-6'>
                ...
                <div className='mt-2 flex items-center'>
                    ...
                    <Link href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light p-2 text-lg font-semibold dark:bg-light dark:text-dark sm:px-4 sm:text-base'>
                        Visit Project
                    </Link>
                </div>
            </div>
    ...
    <>
        ...
        <main className='w-full mb-16 flex flex-col items-center justify-center text-dark dark:text-light'>
            <Layout className='pt-16'>
                <AnimatedText text="My Work in Action" className='mb-16 lg:!text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl'/>
